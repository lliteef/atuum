    ...
    try {
      ...
      const { data: release, error } = await supabase
        ...
        .insert({
          ...
          presave_date: releaseData.presaveDate?.toISOString(),
          ...
          release_date: releaseData.releaseDate?.toISOString(),
          release_name: releaseData.releaseName,
          sales_start_date: releaseData.salesStartDate?.toISOString(),
